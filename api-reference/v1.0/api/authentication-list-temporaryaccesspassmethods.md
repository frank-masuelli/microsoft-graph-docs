...
<!-- { "blockType": "permissions", "name": "authentication_list_temporaryaccesspassmethods_2" } -->
[!INCLUDE [permissions-table](../includes/permissions/authentication-list-temporaryaccesspassmethods-2-permissions.md)]
