...
<!-- { "blockType": "permissions", "name": "workbook_list_names" } -->
[!INCLUDE [permissions-table](../includes/permissions/workbook-list-names-permissions.md)]
...
# [Go](#tab/go)
[!INCLUDE [sample-code](../includes/snippets/go/get-names-2-go-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]

# [PHP](#tab/php)
[!INCLUDE [sample-code](../includes/snippets/php/get-names-2-php-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
