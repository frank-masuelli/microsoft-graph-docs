...
<!-- { "blockType": "permissions", "name": "phoneauthenticationmethod_get_2" } -->
[!INCLUDE [permissions-table](../includes/permissions/phoneauthenticationmethod-get-2-permissions.md)]
