...
### Identity and access | Directory management
Activating a service (organization-activateService) for an organization and for a user (user-activateServicePlan) are deprecated, and will stop returning data on June 30, 2022.
